    ...
    public async Task<IActionResult> ExportToExcelGeneric()
    {
        try
        {
            ...
            var options = new ExcelExportOptions
            {
                ...
                Disclaimer = "**Disclaimer:** \n\nThis report contains historical NAV prices and is for informational purposes only.\n\n**Past performance is not indicative of future results.**",
                // Styling - Title
                ...
                // Styling - Data
                DataFont = new ExcelFontStyle { FontSize = 10, FontColor = "#000000e2" },
                // Styling - Footer
                FooterFont = new ExcelFontStyle { FontSize = 15, Italic = true, FontColor = "#666666" },
                // Styling - Disclaimer
                DisclaimerFont = new ExcelFontStyle { FontSize = 15, FontColor = "#060505e3", Bold = false },
                // Other options
                AutoFitColumns = true,
                ShowBorders = true,
                TableMinimalWidthPixels = 300
            };
