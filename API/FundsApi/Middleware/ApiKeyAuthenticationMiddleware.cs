...
public class ApiKeyAuthenticationMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            _logger.LogDebug("Path {RequestPath} is excluded, bypassing API key check", requestPath);
            await _next(context);
            return;
        }
